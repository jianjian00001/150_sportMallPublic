<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                                                      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="管理员id" prop="adminid">
          <el-input v-model="ruleForm.adminid" 
              placeholder="管理员id" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.adminid" label="管理员id" prop="adminid">
              <el-input v-model="ruleForm.adminid" 
                placeholder="管理员id" readonly></el-input>
                                                                                                ...
                                                                                                <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="是否回复" prop="isreply">
          <el-input v-model="ruleForm.isreply" 
              placeholder="是否回复" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.isreply" label="是否回复" prop="isreply">
              <el-input v-model="ruleForm.isreply" 
                placeholder="是否回复" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="提问" prop="ask">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.ask" label="提问" prop="ask">
                    <span>{{ruleForm.ask}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="回复" prop="reply">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
