  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yonghuxingming" label="用户姓名" prop="yonghuxingming">
              <el-input v-model="ruleForm.yonghuxingming" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.mima" label="密码" prop="mima">
              <el-input v-model="ruleForm.mima" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xingbie" label="性别" prop="xingbie">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lianxidianhua" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
