  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tablename" label="商品表名" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.goodid" label="商品id" prop="goodid">
              <el-input v-model="ruleForm.goodid" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.goodname" label="商品名称" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.buynumber" label="购买数量" prop="buynumber">
              <el-input v-model="ruleForm.buynumber" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.price" label="单价" prop="price">
              <el-input v-model="ruleForm.price" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.discountprice" label="会员价" prop="discountprice">
              <el-input v-model="ruleForm.discountprice" 
