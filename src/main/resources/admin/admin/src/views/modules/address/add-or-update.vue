  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.address" label="地址" prop="address">
              <el-input v-model="ruleForm.address" 
        ...
        <el-form-item class="input" v-if="type!='info'"  label="收货人" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="收货人" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.name" label="收货人" prop="name">
              <el-input v-model="ruleForm.name" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.phone" label="电话" prop="phone">
              <el-input v-model="ruleForm.phone" 
        ...
        <el-form-item class="input" v-if="type!='info'"  label="是否默认地址[是/否]" prop="isdefault">
          <el-input v-model="ruleForm.isdefault" 
              placeholder="是否默认地址[是/否]" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.isdefault" label="是否默认地址[是/否]" prop="isdefault">
              <el-input v-model="ruleForm.isdefault" 
