  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(217, 23, 21, 1);fontSize:28px;">体育运动品商城注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201112/fd2f41809f8d4ffab25025e89ea353b6.jpg");
		height: 100vh;
		...
		.login-form {
			...
			.rgs-form {
				...
				.btn {
					...
					border-color: #409EFF;
					border-radius: 15px;
					background-color: rgba(217, 23, 21, 1);
				}
			}
		}
	}
