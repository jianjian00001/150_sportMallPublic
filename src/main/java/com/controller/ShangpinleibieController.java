...
public class ShangpinleibieController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShangpinleibieEntity shangpinleibie, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShangpinleibieEntity shangpinleibie, HttpServletRequest request){
        EntityWrapper<ShangpinleibieEntity> ew = new EntityWrapper<ShangpinleibieEntity>();
		PageUtils page = shangpinleibieService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shangpinleibie), params), params));
        return R.ok().put("data", page);
    }
